...
export const posts: Post[] = [
  {
    ...
    content: "Contenu à venir… (on fera une page [slug] ensuite).",
  ...
  },
  {
    ...
    focal: "50% 30%", // ✅ visage haut, on vise légèrement au-dessus du centre
    date: "2025-12-08",
  ...
  },
  {
    ...
    focal: "40% 35%", // ✅ sujet un peu à gauche, on évite de couper la tête
    date: "2025-11-30",
