...
export const mediaByEvent: Record<string, MediaItem[]> = {
  ...
  "pique-nique-culturel": [
    ...
    {
      id: "pique-3",
      src: "/images/mediatheque/pique-nique-3.png",
      alt: "Participants profitant d’un atelier en plein air",
      type: "image",
    },
  ],

  "soiree-dansante-live": [
    {
      id: "soiree-bar-1",
      src: "/images/mediatheque/soiree-dansante-live.png",
      alt: "Ambiance chaleureuse au bar avec lumières chaudes et verres colorés.",
      type: "image",
    },
    {
      id: "soiree-foule-1",
      src: "/images/mediatheque/soiree-dansante-artiste.png",
      alt: "Foule en train de danser sur de la musique afro-caribéenne, lumière dorée.",
      type: "image",
    },
    {
      id: "soiree-dj-1",
      src: "/images/mediatheque/soiree-dansante-dj.png",
      alt: "DJ aux platines avec arrière-plan lumineux, soirée dansante Vwa Kiltirèl.",
      type: "image",
    },
  ],
};
