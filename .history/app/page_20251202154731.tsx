        ...
        <div className="flex flex-col gap-3">
          <div className="p-4 rounded-2xl bg-white border border-vwa-background shadow-sm">
            ...
            <p className="text-xs text-vwa-dark/70 mt-1">
              Ateliers, découvertes, événements artistiques qui mettent en avant
              les cultures afro-caribéennes et du monde.
            </p>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-white border border-vwa-background shadow-sm">
            ...
            <p className="text-xs text-vwa-dark/70 mt-1">
              ...
              les futures mamans et les proches.
            </p>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-white border border-vwa-background shadow-sm">
            ...
            <p className="text-xs text-vwa-dark/70 mt-1">
              Sorties en plein air, respiration, mouvement, reconnexion à soi,
