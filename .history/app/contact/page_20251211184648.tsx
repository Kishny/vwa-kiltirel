...
export default function ContactPage() {
    return (
        <main className="relative max-w-5xl mx-auto px-4 py-10 space-y-10">
            {/* Halo / ambiance futuriste */}
            <div className="pointer-events-none absolute inset-0 -z-10">
                <div className="absolute inset-0 bg-gradient-to-b from-vwa-background/0 via-vwa-background/70 to-vwa-background" />
                <div className="absolute -top-24 left-1/2 h-72 w-72 -translate-x-1/2 rounded-full bg-vwa-accent/30 blur-3xl opacity-80" />
                <div className="absolute bottom-[-4rem] right-[-3rem] h-60 w-60 rounded-full bg-vwa-primary/20 blur-3xl opacity-80" />
                {/* grille légère */}
                <div className="absolute inset-0 opacity-[0.08] [background-image:radial-gradient(circle_at_1px_1px,#1f2933_45%,transparent_0)] [background-size:18px_18px]" />
            </div>
            ...
            <section className="grid gap-8 lg:grid-cols-[minmax(0,1.6fr)_minmax(0,1.1fr)] items-start">
                ...
                <div className="space-y-4">
                    ...
                    {/* Card form avec contour néon / effet futuriste */}
                    <div className="relative">
                        {/* contour gradient animé */}
                        <div className="absolute -inset-[1px] rounded-[1.75rem] bg-[conic-gradient(from_120deg_at_50%_50%,rgba(199,140,59,0.6),rgba(20,20,20,0.9),rgba(199,140,59,0.2),rgba(20,20,20,0.9),rgba(199,140,59,0.6))] opacity-70 blur-[2px] animate-[spinBorder_16s_linear_infinite]" />
                        <form
                        ...
                        >
                            ...
                            <div className="grid gap-4 sm:grid-cols-2">
                                {/* Champ nom avec label flottant futuriste */}
                ...
                <aside className="space-y-6">
                    ...
                    <div className="rounded-3xl bg-white/95 border border-vwa-background/90 px-4 py-4 shadow-[0_16px_45px_rgba(28,22,18,0.14)] space-y-3 text-xs text-vwa-dark/80">
                        ...
                        <ul className="list-disc list-inside space-y-1.5">
                            <li>Une idée d’atelier ou de temps fort autour des cultures afro-descendantes.</li>
                            <li>Un partenariat avec une structure, un lieu ou un événement existant.</li>
                            <li>Une invitation pour intervenir dans un établissement ou une structure.</li>
                            <li>Une suggestion pour la programmation ou la vie de l’association.</li>
                        </ul>
                    </div>

                    {/* Bloc “Esprit Vwa Kiltirèl” */}
                    <div className="relative overflow-hidden rounded-3xl bg-vwa-dark text-vwa-background px-4 py-4 shadow-[0_20px_60px_rgba(28,22,18,0.8)]">
                        ...
                        <div className="relative space-y-2 text-xs">
                            ...
                            <p className="text-vwa-background/90">
                                Une association ancrée à Tours, tournée vers les cultures créoles,
                                afro-descendantes et caribéennes, avec une volonté&nbsp;: créer des
                                espaces chaleureux, exigeants et joyeux.
                            </p>
                            <p className="text-vwa-background/85">
                                Votre message contribue à construire les prochains chapitres de cette
                                aventure. Merci d’avance pour votre confiance et vos idées.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="rounded-3xl bg-white/95 border border-vwa-background/90 px-4 py-3 shadow-[0_14px_40px_rgba(28,22,18,0.14)] text-[11px] text-vwa-dark/75 space-y-1.5">
                        <p>
                            Pour toute question liée à vos données personnelles (accès, rectification,
                            suppression), vous pouvez également nous écrire directement à{" "}
                            <a
                                href="mailto:vwakiltirel.asso@gmail.com"
                                className="underline underline-offset-2 hover:text-vwa-primary"
                            >
                        ...
                        <p>
                            Les informations saisies via ce formulaire ne sont jamais revendues ni
                            utilisées à des fins commerciales extérieures à l’association.
                        </p>
                    </div>
                </aside>
            </section>
