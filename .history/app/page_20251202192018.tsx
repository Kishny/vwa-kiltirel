      ...
      <section className="mb-6">
        ...
        <form className="flex gap-2">
          <input
            ...
            className="flex-1 px-3 py-2 rounded-xl border border-black/10 bg-white text-sm text-vwa-dark placeholder:text-vwa-dark/40 focus:outline-none focus:ring-2 focus:ring-vwa-accent/60"
          />
          <button
            type="submit"
            className="px-4 py-2 rounded-xl bg-vwa-primary text-white text-sm font-medium shadow-sm hover:bg-vwa-primary/90 transition"
          >
            OK
          </button>
        </form>
