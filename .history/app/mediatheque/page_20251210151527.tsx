...
import MediathequeView, { EventWithMedia } from "@/components/mediatheque/MediathequeView";
...
export default async function MediathequePage({ searchParams }: MediathequePageProps) {
