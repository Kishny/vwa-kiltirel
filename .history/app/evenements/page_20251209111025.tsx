                                ...
                                <div className="flex flex-col sm:flex-row">
                                    ...
                                    <div className="relative w-full sm:w-64 md:w-72">
                                        <Image
                                            ...
                                            width={640}
                                            height={400}
                                            className="h-full w-full object-cover sm:rounded-r-3xl sm:rounded-l-none rounded-b-3xl sm:rounded-b-none"
                                            priority={event.slug === "brunch-mamans-reconnexion"} // juste pour le premier
                                        />
                                    </div>
