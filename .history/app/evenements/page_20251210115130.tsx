                ...
                <div className="flex items-baseline justify-between gap-4">
                    ...
                    {upcomingEvents.length > 0 && (
                        <span className="text-[11px] text-vwa-dark/55">
                            Cliquez sur une carte pour voir le détail, ou inscrivez-vous
                            directement.
                        </span>
                    )}
                </div>
                ...
                {upcomingEvents.length === 0 ? (
                    ...
                    <ul className="space-y-4">
                        {upcomingEvents.map((event) => (
                            <li key={event.slug}>
                                {/* Toute la card est cliquable vers la fiche événement */}
                                <Link
                                    href={`/evenements/${event.slug}`}
                                    className="group block rounded-3xl bg-white/95 border border-vwa-background/80 shadow-[0_16px_45px_rgba(28,22,18,0.10)] overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_24px_70px_rgba(28,22,18,0.18)]"
                                >
                                        ...
                                        <div className="flex-1 p-5 sm:p-6 space-y-3">
                                            ...
                                            <div className="mt-2 space-y-2">
                                                <div className="flex flex-wrap items-center gap-3">
                                                    ...
                                                    {/* CTA inscription : ne casse pas le clic global */}
                                                    <button
                                                        type="button"
                                                        onClick={(e) => {
                                                            e.preventDefault();
                                                    ...
                                                    {/* Lien détails */} <Link href={/evenements/${event.slug}} className="text-xs font-medium text-vwa-primary underline-offset-2 hover:text-vwa-dark hover:underline transition-colors" > Voir les détails </Link>
                                            </div>
