...
// 🔥 IMPORTANT : ici on NE met PAS Promise
        ...
        <main className="max-w-2xl mx-auto px-4 py-10 space-y-8">
                ...
                <form className="space-y-4">
                    ...
                    {isPaid && (
                        <p className="text-xs text-vwa-dark/70">
                            ...
                            demandée via un lien de paiement sécurisé (HelloAsso) ou sur place.
                            Tous les détails seront précisés dans l&apos;email de confirmation.
                        </p>
                    )}
            ...
            <section className="space-y-2">
                ...
                <ul className="list-disc list-inside text-xs text-vwa-dark/75 space-y-1">
                    <li>Les inscriptions sont nominatives.</li>
                    <li>
