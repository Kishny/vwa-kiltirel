...
export default function Home() {
  return (
    <div className="flex flex-col gap-10 py-6">
      ...
      {/* PROCHAIN ÉVÉNEMENT */}
      <section>
        <h2 className="text-lg font-semibold mb-3">Prochain événement</h2>

        <div className="bg-white shadow-sm p-4 rounded-2xl border border-slate-100 flex flex-col gap-2">
          <span className="text-xs uppercase text-slate-500">
            Atelier parents-enfants
          </span>
          <p className="font-medium text-slate-800">
            Soirée découverte Vwa Kiltirèl
          </p>

          <p className="text-sm text-slate-600">Samedi 14 mars • 19h – Tours Nord</p>

          <Link
            href="/evenements/prochain-evenement"
            className="mt-2 text-center text-sm px-3 py-2 rounded-full bg-slate-900 text-white"
          >
            Je m’inscris
          </Link>
        </div>
