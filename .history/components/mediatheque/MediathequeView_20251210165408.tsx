...
export default function MediathequeView({
    ...
    return (
        <div className="space-y-10">
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
                    <div className="space-y-2">
                        ...
                        <p className="text-sm text-vwa-dark/75 max-w-2xl">
                            Retrouvez les photos des ateliers, soirées, rencontres et événements Vwa
                            Kiltirèl, ainsi que des instantanés de la vie de l’association.
                        </p>
                    </div>
            ...
            {/* LIGHTBOX commune (événements + asso) */}
            {lightboxMedia && (
                <div
                ...
                >
                    ...
                    >
                        ...
                        <div className="px-4 py-3 text-xs text-vwa-background/90">
                            <p className="font-semibold">{lightboxMedia.contextTitle}</p>
                            <p className="text-vwa-background/80">{lightboxMedia.media.alt}</p>
                        </div>
                    </div>
                </div>
            )}
