...
export default function Header() {
    ...
    return (
        <header className="sticky top-0 z-40 border-b border-vwa-accent/20 bg-gradient-to-r from-vwa-background/90 via-vwa-background/95 to-vwa-background/90 backdrop-blur">
            <div className="max-w-4xl mx-auto w-full px-4 py-3 flex items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div className="hidden md:flex items-center gap-2">
                        <Link
                            href="/don"
                            className="text-xs px-3 py-1.5 rounded-full border border-vwa-accent text-vwa-accent hover:bg-vwa-accent hover:text-white transition"
                        >
                            Faire un don
                        </Link>
                        <Link
