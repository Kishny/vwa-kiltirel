...
export default function EventInscriptionForm({
  ...
  const formSchema = {
    ...
    description: `Formulaire d'inscription pour l'événement ${event.title} organisé par Vwa Kiltirèl.`,
    mainEntity: {
      "@type": "Event",
      name: event.title,
      organizer: {
          ...
          {success && submittedData && (
            <div className="relative overflow-hidden rounded-[2rem] border border-emerald-300/40 bg-gradient-to-br from-emerald-50 via-white to-emerald-100/70 px-6 py-6 shadow-[0_25px_60px_rgba(16,185,129,0.18)] animate-[fadeIn_0.45s_ease] backdrop-blur-sm">
              <div className="pointer-events-none absolute inset-0">
                ...
                <div className="absolute left-1/2 top-1/2 h-40 w-40 -translate-x-1/2 -translate-y-1/2 rounded-full bg-emerald-300/5 blur-2xl" />
              </div>
              ...
              <div className="relative flex flex-col gap-6">
                  ...
                  <div className="grid gap-3 text-sm sm:grid-cols-2">
                    ...
                    {submittedData.message && (
                      <div className="col-span-2 mt-1 rounded-xl bg-emerald-50/80 p-3">
                        <span className="mb-1 block text-xs font-medium text-vwa-dark/60">
                          💬 Message
                        </span>
                ...
                <div className="flex flex-wrap gap-3 sm:justify-end">
                  <Link
                    href="/evenements"
                    className="inline-flex items-center justify-center gap-2 rounded-full border border-vwa-dark/15 bg-white px-5 py-2.5 text-sm font-medium text-vwa-dark transition hover:border-vwa-primary hover:text-vwa-primary"
                  >
                    <svg
          ...
          >
            <div className="grid gap-5 sm:grid-cols-2">
              <div className="group space-y-1.5">
                <label className="flex items-center justify-between text-xs font-semibold text-vwa-dark/80">
                  <span>Prénom</span>
                  <span className="text-[10px] text-vwa-accent/80">
                    Obligatoire
                  </span>
                </label>
                ...
                {fieldErrors.firstName && (
                  <p id="firstName-error" className="text-[11px] text-red-600">
                    {fieldErrors.firstName}
                  </p>
                )}
              </div>
              ...
              <div className="group space-y-1.5">
                ...
                {fieldErrors.lastName && (
                  <p id="lastName-error" className="text-[11px] text-red-600">
                    {fieldErrors.lastName}
                  </p>
                )}
              </div>
            ...
            <div className="grid gap-5 sm:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)]">
              <div className="group space-y-1.5">
                ...
                {fieldErrors.email && (
                  <p id="email-error" className="text-[11px] text-red-600">
                    {fieldErrors.email}
                  </p>
                )}
              </div>
              ...
              <div className="group space-y-1.5">
                ...
                {fieldErrors.phone && (
                  <p id="phone-error" className="text-[11px] text-red-600">
                    {fieldErrors.phone}
                  </p>
                )}
              </div>
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              <div className="group space-y-1.5">
                ...
                <input
                  ...
                  aria-describedby={
                    fieldErrors.adults ? "adults-error" : undefined
                  }
                  className={inputBaseClass(Boolean(fieldErrors.adults))}
                />

                {fieldErrors.adults && (
                  <p id="adults-error" className="text-[11px] text-red-600">
                    {fieldErrors.adults}
                  </p>
                )}
              </div>
              ...
              <div className="group space-y-1.5">
                ...
                <input
                  ...
                  aria-describedby={
                    fieldErrors.children ? "children-error" : undefined
                  }
                  className={inputBaseClass(Boolean(fieldErrors.children))}
                />

                {fieldErrors.children && (
                  <p id="children-error" className="text-[11px] text-red-600">
                    {fieldErrors.children}
                  </p>
                )}
              </div>
            ...
            <div className="group space-y-1.5">
              ...
              {fieldErrors.message && (
                <p id="message-error" className="text-[11px] text-red-600">
                  {fieldErrors.message}
                </p>
              )}
            </div>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs leading-relaxed">
                      Pour cet événement, une participation pourra être demandée
                      via un lien de paiement sécurisé ou sur place. Tous les
                      détails seront précisés dans l’email de confirmation.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-3 pt-2">
              ...
              <p className="text-center text-[11px] text-vwa-dark/50">
                Après validation, vous recevrez un email de confirmation avec
