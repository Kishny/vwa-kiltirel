      ...
      <section aria-labelledby="next-events-title" className="mt-4">
        ...
        <div className="rounded-3xl border border-vwa-background/80 bg-white/90 px-5 py-6 shadow-[0_18px_55px_rgba(71,41,24,0.10)]">
          <p className="text-sm text-vwa-dark/75">
            Aucun événement à venir pour le moment. De belles choses se préparent en coulisses…
          </p>
        </div>
      </section>
    );
    ...
    <section aria-labelledby="next-events-title" className="mt-4 space-y-3">
      <div className="flex items-center justify-between gap-3">
        <div>
          ...
          <p className="text-[11px] text-vwa-dark/55 mt-0.5">
        ...
        <Link
          href="/evenements"
          className="inline-flex items-center gap-1 text-xs font-medium text-vwa-primary hover:text-vwa-blueSoft transition"
        >
          Tout voir
      ...
      <article className="group relative overflow-hidden rounded-[1.75rem] border border-vwa-background/80 bg-white/95 shadow-[0_20px_60px_rgba(71,41,24,0.14)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1.15fr_0.95fr]">
          ...
          <div className="relative z-10 flex flex-col justify-between p-5 sm:p-6 md:p-7">
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <h3 className="text-lg sm:text-xl font-extrabold text-vwa-dark leading-snug max-w-xl">
                  {event.title}
                </h3>

                <p className="text-sm text-vwa-dark/72 leading-relaxed max-w-xl">
            ...
            <div className="mt-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex flex-wrap items-center gap-2">
                <Link
                  ...
                  className="group/cta inline-flex items-center justify-center gap-2 rounded-full px-4 py-2 text-xs sm:text-sm font-semibold text-white shadow-[0_14px_30px_rgba(71,41,24,0.28)] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_18px_40px_rgba(71,41,24,0.36)] active:scale-[0.98]
                ...
                <Link
                  ...
                  className="inline-flex items-center justify-center rounded-full border border-vwa-dark/10 bg-white px-4 py-2 text-xs sm:text-sm font-medium text-vwa-dark/80 shadow-sm transition-all duration-200 hover:border-vwa-primary/25 hover:text-vwa-primary"
                >
                  Voir la fiche
                </Link>
              </div>
          ...
          {/* Partie image */}
          <div className="relative min-h-[240px] md:min-h-full bg-vwa-background overflow-hidden">
            <Image
              src={event.image}
              alt={event.title}
              fill
